...
def parse_FILL(parser):
    ...
    # Get the constant scalar value
    fill_value = parser.get_constant_node(parser.inputs[1])
    
    # Must wrap into a tensor of shape [1]
    value_tensor = np.array([fill_value], dtype=np.float32)
